...
#ifndef GOOGLE_PROTOBUF_INCLUDED_mavcam_5foptions_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_mavcam_5foptions_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_mavcam_5foptions_2eproto
...
struct TableStruct_mavcam_5foptions_2eproto {
...
template <>
struct is_proto_enum<::mavcam::options::AsyncType> : std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor<::mavcam::options::AsyncType>() {
  return ::mavcam::options::AsyncType_descriptor();
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_mavcam_5foptions_2eproto_2epb_2eh
